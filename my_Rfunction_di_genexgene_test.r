...
analysis<-function(outfile=NULL,Gnomad_AF1_low=0.1,Gnomad_AF1_up=0.9,Gnomad_AF2=0.0001,AAF1=1,AAF2=1,set1=c("frameshift","stop_gained","stop_lost","start_lost","splice_donor","splice_acceptor"),set2="ALL",
  ...
  write.table(resultpar,file=paste(feno,"/di/pvalues/di_genexgene_Gnomad_AF1",Gnomad_AF1,"_Gnomad_AF2",Gnomad_AF2,"_AF1",AAF1,"_AF2",AAF2,"_",effects,"_vcf.out",sep=""),row.names=F,col.names=T,quote=F,sep="\t")
  stopCluster(cl)
  return(resultpar)
}